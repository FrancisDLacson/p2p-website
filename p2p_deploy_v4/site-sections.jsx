    ...
    <section style={{ position: 'relative', overflow: 'hidden',
      ...
      <Container style={{ paddingTop: 84, paddingBottom: 72 }}>
        <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.02fr 0.98fr', gap: 56, alignItems: 'center' }}>
          {/* left */}
          <div>
            <h1 className="grotesk" style={{ fontSize: 'clamp(34px, 4.4vw, 56px)', fontWeight: 700, color: INK,
                                              letterSpacing: '-0.038em', lineHeight: 1.04, margin: '0' }}>
              What is your procurement data trying to tell you?
            </h1>
            <p style={{ ...leadStyle(19, SLATE), margin: '22px 0 0', maxWidth: 540 }}>
              Hidden inside every procurement system are warning signs — weak competition, vendor concentration,
              payment delays — that stay invisible until they become a budget issue, an audit finding, or a headline.
            </p>
            <div style={{ display: 'flex', gap: 12, marginTop: 30, flexWrap: 'wrap' }}>
              <Button variant="primary" size="lg" href="https://outlook.office.com/book/Miller3Consulting1@miller3group.onmicrosoft.com/?ismsaljsauthenabled">Book a demo →</Button>
            </div>
          </div>
...
// ═══════════════════════════════════════════════════════════════════════════
// DATA SIGNAL — hero follow-up statement
// ═══════════════════════════════════════════════════════════════════════════
function DataSignal() {
  return (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '0.34fr 1fr', gap: 48, alignItems: 'start' }}>
          ...
          <div style={{ maxWidth: 720, display: 'flex', flexDirection: 'column', gap: 18 }}>
            <p className="grotesk" style={{ fontSize: 22, fontWeight: 700, color: INK, letterSpacing: '-0.02em', lineHeight: 1.28, margin: 0 }}>
              Miller³ Consulting was founded on a simple premise: excellence in public sector management.
            </p>
            <p style={{ ...bodyStyle(17, SLATE), margin: 0 }}>
              For more than four decades, we’ve helped governments, transit authorities, health systems, and
              public agencies solve complex operational challenges, strengthen institutional performance, and
              build organizations equipped to serve their communities.
            </p>
            <p style={{ ...bodyStyle(17, SLATE), margin: 0 }}>
              Over time, one truth became increasingly clear: procurement sits at the center of nearly every
              strategic priority in government. It influences financial stewardship, operational efficiency,
              supplier performance, economic opportunity, and public trust.
            </p>
            <p style={{ ...bodyStyle(17, SLATE), margin: 0 }}>
              Today, we bring that broader management perspective to procurement—helping organizations transform
              it from a compliance function into a strategic driver of operational excellence and community impact.
            </p>
          </div>
        </div>
      </Container>
